    ...
    .map((item, index) => {
      ...
      <div class="menu-card animate-fade-in">
          ...
          <div class="card-body">
              ...
              ${item.desc ? `<p class="card-text text-muted small mb-2" style="font-size: 0.85rem; line-height: 1.4;">${item.desc}</p>` : ""}
